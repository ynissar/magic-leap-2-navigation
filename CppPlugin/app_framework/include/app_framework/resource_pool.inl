...
// Use of this file is governed by your Early Access Terms and Conditions. This software is an Early Access Product.
// %COPYRIGHT_END%
// ---------------------------------------------------------------------
// %BANNER_END%
#pragma once
...
std::shared_ptr<Type> ResourcePool::GetOrCreateElement(
    std::unordered_map<std::string, std::shared_ptr<ParentType>> &cache, const std::string &key, Args &&... args) {
...
template <typename Type, typename ParentType, typename... Args>
std::shared_ptr<Type> ResourcePool::CreateCacheElement(
    std::unordered_map<std::string, std::shared_ptr<ParentType>> &cache, const std::string &key, Args &&... args) {
...
std::shared_ptr<ParentType> ResourcePool::GetCacheElement(
    const std::unordered_map<std::string, std::shared_ptr<ParentType>> &cache, const std::string &key) const {

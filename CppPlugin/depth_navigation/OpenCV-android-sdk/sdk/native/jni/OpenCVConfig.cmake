...
if(NOT DEFINED OpenCV_CONFIG_SUBDIR)
  # ANDROID_NDK_ABI_NAME is set by the Android CMake toolchain; fall back to ANDROID_ABI or CMAKE_ANDROID_ARCH_ABI when running without it (e.g. for compile_commands only)
  set(_abi "${ANDROID_NDK_ABI_NAME}")
  if(NOT _abi AND DEFINED ANDROID_ABI)
    set(_abi "${ANDROID_ABI}")
  endif()
  if(NOT _abi AND DEFINED CMAKE_ANDROID_ARCH_ABI)
    set(_abi "${CMAKE_ANDROID_ARCH_ABI}")
  endif()
  set(OpenCV_CONFIG_SUBDIR "/abi-${_abi}")
endif()
